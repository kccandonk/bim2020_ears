...
class Dataset:
    ...
    train_folder = '/home/ubuntu/ears/bim2020_ears/aws_scripts/ears_features/train'
    #validation_folder = 'ears_features/PublicTest'
    #test_folder = 'ears_features/test'
    test_folder = '/home/ubuntu/ears/bim2020_ears/aws_scripts/ears_features/test'
...
class Hyperparams:
    rate = 1 - 0.956   # dropout = 1 - keep_prob
    learning_rate = 0.016
